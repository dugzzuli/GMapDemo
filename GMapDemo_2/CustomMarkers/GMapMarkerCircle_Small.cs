...
#if !PocketPC
    [Serializable]
    public class GMapMarkerCircle_Small : GMapMarker, ISerializable
#else
   public class GMapMarkerCircle : GMapMarker
#endif
    {
      ...
      public Brush Fill = new System.Drawing.SolidBrush(Color.AliceBlue);
        ...
        public GMapMarkerCircle_Small(PointLatLng p) : base(p)
        {
            Radius = 888; // 888m
        ...
        protected GMapMarkerCircle_Small(SerializationInfo info, StreamingContext context)
           : base(info, context)
        {
            // TODO: Radius, IsFilled
        }
